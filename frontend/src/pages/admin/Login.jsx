...
export default function LoginAdmin() {
  ...
  return (
    <div className="min-h-screen bg-white text-black flex items-center justify-center px-4 font-mono">
      <div className="bg-white-100 p-6 border border-gray-300 rounded w-full max-w-lg text-center shadow">
